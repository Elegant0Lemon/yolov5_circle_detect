...
class Loggers():
    ...
    def on_pretrain_routine_end(self, labels, names):
        ...
        if self.plots:
            ...
            # if self.clearml:
            #    pass  # ClearML saves these image automatically using hooks
            if self.comet_logger:
    ...
    def on_train_end(self, last, best, epoch, results):
        ...
        if self.tb and not self.clearml:  # These image are already captured by ClearML by now, we don't want doubles
            for f in files:
